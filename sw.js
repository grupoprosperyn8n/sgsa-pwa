// SGSA PWA v30 — all messages left-aligned with gray background (theirs style)
// Strategy: network-first for HTML, cache-first for hashed assets, network-only for API
const CACHE_V="sgsa-v30";
const CACHE_STATIC="sgsa-static-v30";
