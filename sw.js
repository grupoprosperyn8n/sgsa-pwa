// SGSA PWA v7 — Service Worker
const CACHE="sgsa-v7",ASSETS=["/","/index.html","/pwa.css","/pwa.js","/manifest.webmanifest","/icons/icon128.png","/icons/icon48.png","/icons/icon16.png"];
