// SGSA PWA v36 — kanban board, calendar list view, task history, edit/delete
// Strategy: network-first for HTML, cache-first for hashed assets, network-only for API
const CACHE_V="sgsa-v36";
const CACHE_STATIC="sgsa-static-v36";
