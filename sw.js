// SGSA PWA v44 — calendar day/week/month views, fixed grid sizing, event fixes
// Strategy: network-first for HTML, cache-first for hashed assets, network-only for API
const CACHE_V="sgsa-v44";
const CACHE_STATIC="sgsa-static-v44";
