// SGSA PWA v24 — file vault: word-break in grid cards + title tooltip for full name
// Strategy: network-first for HTML, cache-first for hashed assets, network-only for API
const CACHE_V="sgsa-v24";
const CACHE_STATIC="sgsa-static-v24";
...
self.addEventListener("activate",e=>{
  e.waitUntil(
    caches.keys().then(keys=>Promise.all(
      keys.filter(k=>k!==CACHE_STATIC&&k!==CACHE_V&&k!=="sgsa-v23"&&k!=="sgsa-v22"&&k!=="sgsa-v21"&&k!=="sgsa-v20"&&k!=="sgsa-v19"&&k!=="sgsa-v18"&&k!=="sgsa-v17"&&k!=="sgsa-v16"&&k!=="sgsa-v15"&&k!=="sgsa-v14"&&k!=="sgsa-v13"&&k!=="sgsa-v12"&&k!=="sgsa-v11"&&k!=="sgsa-v10"&&k!=="sgsa-v9"&&k!=="sgsa-v8"&&k!=="sgsa-v7"&&k!=="sgsa-v6"&&k!=="sgsa-v5")
