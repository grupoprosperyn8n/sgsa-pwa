// SGSA PWA v42 — calendar day/week/month views, fixed grid sizing, event fixes
// Strategy: network-first for HTML, cache-first for hashed assets, network-only for API
const CACHE_V="sgsa-v42";
const CACHE_STATIC="sgsa-static-v42";
