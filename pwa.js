...
function renderMsgList(c,e,gid,msgs){
  ...
  for(const m of sorted){
    ...
    else if(m.adjunto_url)body=`<div class="msg-attachment"><a class="file-link" href="${m.adjunto_url}" target="_blank"><span class="material-symbols-outlined" style="font-size:16px">attach_file</span><span class="file-link-text" title="${esc(m.adjunto_nombre||"Archivo")}">${esc(m.adjunto_nombre||"Archivo")}</span></a></div>`;
