...
function renderConversations(){
  ...
  c.querySelectorAll(".delete-chat-btn").forEach(b=>b.addEventListener("click",async e=>{e.stopPropagation();const gid=b.dataset.gid;if(confirm("¿Eliminar este chat?")){try{await fetch(API+"/api/chat/groups/"+gid+"/leave",{method:"DELETE",headers:authToken?{Authorization:"Bearer "+authToken}:{}})}catch(e){}refreshConversations()}}));
}
